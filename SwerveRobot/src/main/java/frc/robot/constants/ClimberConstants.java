...
public class ClimberConstants {
    ...
    public static final double CLIMBER_TELE_BASE_HEIGHT = 1; //FIXME
    public static final double CLIMBER_TELE_PULLEY_DIAMETER = 1.5; //FIXME

    public static final int CLIMBER_LEFT_SWING_MOTOR_ID = 247; // FIXME: Fix me (this means fix me)
    public static final int CLIMBER_RIGHT_SWING_MOTOR_ID = 257;
